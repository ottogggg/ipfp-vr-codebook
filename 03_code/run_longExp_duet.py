...
parser.add_argument('--model', type=str,  default='Duet', help='model name RIMF SparseTSF')
...
# duet
parser.add_argument('--noisy_gating', type=bool, default=True, help='noisy_gating')
parser.add_argument('--num_experts',type=int,default=2,help='an integer - number of experts')
parser.add_argument('--k',type=int,default=1,help='an integer - number of experts')
parser.add_argument('--hidden_size',type=int,default=256,help='hidden_size')
parser.add_argument('--CI', type=bool, default=False, help='noisy_gating')
