...
parser.add_argument('--model', type=str,  default='RIMF', help='model name RIMF SparseTSF MSCF')
...
parser.add_argument('--corr_list',type=list)
parser.add_argument('--period_list_str', type=str, default='[24,12]', help='多周期')
...
parser.add_argument('--patch', type=int, default=24, help='patch size for SparseTSF')
parser.add_argument('--mdm_k', type=int, default=3, help='k for MDM module')
parser.add_argument('--mdm_c', type=int, default=2, help='c for MDM module')
parser.add_argument('--ff_dim', type=int, default=512, help='ff dimension for MOE')
parser.add_argument('--num_experts', type=int, default=4, help='number of experts in MOE')
parser.add_argument('--top_k', type=int, default=2, help='top k for MOE gating')
parser.add_argument('--layernorm', type=int, default=1, help='use layernorm in MDM')
parser.add_argument('--norm', type=int, default=1, help='use RevIN normalization')

# MSCF
parser.add_argument('--ms_num_scales', type=int, default=4, help='number of scales for MSCF')
parser.add_argument('--ms_pool_stride', type=int, default=2, help='avg pooling stride for MSCF decomposition')
parser.add_argument('--ms_fusion', type=str, default='learnable', help='fusion type for MSCF')
...
# random seed
fix_seed_list = range(2025, 2033)

# 解析 cluster_list 参数
args.period_list = json.loads(args.period_list_str)
args.use_gpu = True if torch.cuda.is_available() and args.use_gpu else False
args.num_samples =int(args.enc_in * args.samples_ratio)
...
if args.is_training:
    for ii in range(args.itr):
        ...
        corr_list= exp.pre_train(setting)
        args.corr_list = corr_list
