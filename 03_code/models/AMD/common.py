...
class SparseTSFModel(nn.Module):
    def __init__(self, input_shape,pred_len,patch):
        super(SparseTSFModel, self).__init__()



        # get parameters
        self.seq_len = input_shape[0]
        self.pred_len = input_shape[0]
        self.enc_in = input_shape[1]
        self.period_len = patch
        self.d_model = 512
        self.model_type = 'mlp'
